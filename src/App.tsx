  ...
  return (
    <div className="flex flex-col min-h-screen bg-stone-900 text-white">
      ...
      <footer className="text-gray-400 text-center mt-8 p-4">
        <a href='#' className='underline-offset-2 underline' onClick={togglePopup}>Terms of Service</a>
        <p>
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-slate-100 text-black p-8 rounded-lg shadow-lg max-w-lg w-full">
